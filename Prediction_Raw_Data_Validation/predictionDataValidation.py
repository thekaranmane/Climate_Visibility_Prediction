...
class Prediction_Data_validation:
    ...
    def validationFileNameRaw(self,regex,LengthOfDateStampInFile,LengthOfTimeStampInFile,folderPath):
        """
                ...
                if (re.match(regex, filename)):
                    ...
                    if len(splitAtDot[1]) == LengthOfDateStampInFile:
                        if len(splitAtDot[2]) == LengthOfTimeStampInFile:
                            ...
                            shutil.copy(folderPath+"/" + filename, "Prediction_Raw_Files_Validated/Good_Raw")
                            self.logger.log(f,"Valid File name!! File moved to GoodRaw Folder :: %s" % filename)

                        else:
                            # shutil.copy("Prediction_Batch_files/" + filename, "Prediction_Raw_Files_Validated/Bad_Raw")
                            shutil.copy(folderPath+"/" + filename, "Prediction_Raw_Files_Validated/Bad_Raw")
