...
class prediction:
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            path = "static/Prediction_Output_File/Predictions.csv"
            result.to_csv("static/Prediction_Output_File/Predictions.csv",header=True) #appends result to prediction file
